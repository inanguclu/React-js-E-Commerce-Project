        ...
        <div className="col-12 col-md-9 col-lg-7 col-xl-6">
          <div className="card p-lg-5">
            <div className="card-body p-5">
              <h2 className="text-center fw-bold fs-3 modal-title mb-3">Giriş Paneli</h2>
              <form onSubmit={sendFnc} method='post'>
                ...
                <div className="form-outline mb-3">
                  <input value={password} onChange={(evt) => setPassword(evt.target.value)} type="password" className="form-control" id="password" placeholder='Şifre' />
                </div>
                ...
                <div className='d-grid gap-2 mt-4'>
                  <button type="submit" className="btn btn-success"><i className="bi bi-person " ></i> Giriş..</button>&nbsp;
                </div>
              </form>
            </div>
          </div>
